...
class RAPAF_ADMIN_Commons {
    ...
    public static function get_update_list_from_remote_csv($url) {
        ...
        $request = wp_remote_get( $url, array( 'headers' => array(self::API_AUTH_KEY_NAME => self::API_AUTH_KEY_VALUE) ));
    ...
    */
    ...
    public static function is_wprm_premium_active() {
        return is_plugin_active('wp-recipe-maker-premium/wp-recipe-maker-premium.php');
    }

    public static function are_third_party_dependencies_met() {
        return self::is_wprm_active() && self::is_wprm_premium_active();
    }

    public static function get_wprm_details() {
        return get_plugin_data('/wp-recipe-maker/wp-recipe-maker.php');
    }
